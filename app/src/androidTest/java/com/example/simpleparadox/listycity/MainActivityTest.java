...
public class MainActivityTest{
    ...
    public void checkList(){
        ...
        solo.enterText((EditText) solo.getView(R.id.editText_name), "1707011Paul");
        ...
        /* True if there is any text: 1707011Paul on the screen, wait at least 2 seconds and
        find minimum one match. */
        assertTrue(solo.waitForText("1707011Paul", 1, 2000));

        solo.clickOnButton("CLEAR ALL"); //Select ClEAR ALL
        //True if there is no text: 1707011Paul on the screen
        assertFalse(solo.searchText("1707011Paul"));
    ...
    public void checkCiyListItem(){
        ...
        solo.waitForText("1707011Paul", 1, 2000);
